...
public class TrendingActivity extends AppCompatActivity implements OnStopTrackEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityVideosBinding.toolbar.titleTx.setText("Trending");
      ...
      /*  service.Posts(1,10,
            ...
            public void onResponse(Call<PostsPojoOne> call, Response<PostsPojoOne> response) {
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    verticalViewPager.setAdapter(new VerticlePagerAdapter(TrendingActivity.this, listener, postsPojoOne.getData()));
