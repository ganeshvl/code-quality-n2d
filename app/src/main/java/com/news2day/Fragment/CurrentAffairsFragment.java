...
import com.news2day.Adapter.HomeRecyclerAdapter;
...
public class CurrentAffairsFragment extends Fragment {
     ...
     * @return A new instance of fragment CurrentAffairsFragment.
     */
...
//        HomeRecyclerAdapter currentAffairsFragAdapter = new HomeRecyclerAdapter(getActivity());
//        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
//        recyclerView.setLayoutManager(linearLayoutManager);
//        recyclerView.setAdapter(currentAffairsFragAdapter);
