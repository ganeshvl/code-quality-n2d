...
import com.news2day.Activity.PoliticsActvity;
...
public class PoliticsAdapter extends RecyclerView.Adapter<PoliticsAdapter.ViewHolder> {
    ...
    public PoliticsAdapter(Context context, ArrayList<String> name, ArrayList<Integer> image) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, PoliticsActvity.class);
